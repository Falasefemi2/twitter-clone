...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, onSubmit, title, body, footer, actionLabel, disabled }) => {
    ...
    return (
        <>
            <div className="justify-center items-center flex overflow-hidden overflow-y-hidden fixed inset-4 z-50 outline-none focus:outline-none bg-neutral-800  bg-opacity-70">
                <div className="relative w-full lg:w-3/6 my-6 mx-auto lg:max-x-3xl h-full lg:h-auto">
                    {/* Content */}
